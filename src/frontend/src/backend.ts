...
export class Backend implements backendInterface {
    ...
    async getAllDayLogs(): Promise<Array<DayLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDayLogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyLogsByCompletionStats(): Promise<Array<DailyLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyLogsByCompletionStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDayLog(arg0: bigint): Promise<DayLog> {
        if (this.processError) {
            try {
                const result = await this.actor.getDayLog(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDayLog(arg0: DailyLogInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDayLog(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
